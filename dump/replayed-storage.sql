...
CREATE POLICY "media bucket: delete own" ON "storage"."objects" FOR DELETE USING ((("bucket_id" = 'media'::"text") AND ("auth"."role"() = 'authenticated'::"text") AND (("storage"."foldername"("name"))[1] = ("auth"."uid"())::"text")));



CREATE POLICY "media bucket: insert own" ON "storage"."objects" FOR INSERT WITH CHECK ((("bucket_id" = 'media'::"text") AND ("auth"."role"() = 'authenticated'::"text") AND (("storage"."foldername"("name"))[1] = ("auth"."uid"())::"text")));



CREATE POLICY "media bucket: select" ON "storage"."objects" FOR SELECT USING (("bucket_id" = 'media'::"text"));
